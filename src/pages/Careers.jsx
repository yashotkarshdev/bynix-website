...
const JobCard = ({id, title, experience, location }) => {
...
const Careers = () => {
    const jobs = [
        { id: "it-sales", title: "IT Sales", exp: "2+ years", loc: "Gandhi Path, Jaipur" },
        { id: "seo-executive", title: "SEO Executive", exp: "3+ years", loc: "Gandhi Path, Jaipur" },
        { id: "marketing-executive", title: "Marketing Executive", exp: "2+ years", loc: "Gandhi Path, Jaipur" },
        { id: "seo-intern", title: "SEO Intern", exp: "0-6 months", loc: "Gandhi Path, Jaipur" },
        { id: "content-writer", title: "Content Writer", exp: "2+ years", loc: "Gandhi Path, Jaipur" },
        { id: "flutter-developer", title: "Flutter App Developer", exp: "3+ years", loc: "Gandhi Path, Jaipur" },
    ];

    ...
    return (
        <>
            ...
            <section className="relative py-20 overflow-hidden"> {/* removed bg-white */}
                    ...
                    <div className="container mx-auto px-6 lg:px-18 relative z-10">
                        ...
                        <div className="grid lg:grid-cols-2 gap-20 items-center">
                            <div className="order-2 lg:order-1 flex justify-center">
                                <img src="/web-app-development/mockup.png" alt="Mockup" className="max-w-md w-full drop-shadow-xl" />
                            </div>
                ...
                <section className="relative py-20 bg-white/20 overflow-hidden">

                    <div className="container mx-auto px-6 lg:px-18 relative z-10">

                        {/* Floating "SERVICES WE OFFER" Badge */}
